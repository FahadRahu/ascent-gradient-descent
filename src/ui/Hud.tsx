...
export function Hud({ graphicsStatus }: { graphicsStatus: GraphicsStatus }) {
  ...
  const [activeTab, setActiveTab] = useState<ResponsiveTabId>('setup');
  ...
  return (
    <div className="hud-layer">
      ...
      <div className="mobile-control-region">
        {isMobileLayout ? (
          <ResponsiveTabs activeTab={activeTab} onSelect={setActiveTab} />
        ) : null}

        <div
          className="concept-panel"
          data-mobile-active={activeTab === 'learn' || activeTab === 'signal'}
        >
          <section
            id="responsive-panel-learn"
            className="learn-panel"
            role={isMobileLayout ? 'tabpanel' : undefined}
            tabIndex={isMobileLayout ? 0 : undefined}
            aria-labelledby={isMobileLayout ? 'responsive-tab-learn' : 'concept-title'}
            hidden={isMobileLayout && activeTab !== 'learn'}
          >
          ...
          <div
            id="responsive-panel-signal"
            className="signal-panel"
            role={isMobileLayout ? 'tabpanel' : undefined}
            tabIndex={isMobileLayout ? 0 : undefined}
            aria-labelledby={isMobileLayout ? 'responsive-tab-signal' : undefined}
            hidden={isMobileLayout && activeTab !== 'signal'}
          >
            <LiveSignal
        ...
        <aside
          ...
          data-mobile-active={activeTab === 'setup' || activeTab === 'playback'}
        >
          <section
            id="responsive-panel-setup"
            className="setup-panel"
            role={isMobileLayout ? 'tabpanel' : undefined}
            tabIndex={isMobileLayout ? 0 : undefined}
            aria-labelledby={isMobileLayout ? 'responsive-tab-setup' : 'setup-title'}
            hidden={isMobileLayout && activeTab !== 'setup'}
          >
          ...
          <section
            id="responsive-panel-playback"
            className="playback-panel"
            role={isMobileLayout ? 'tabpanel' : undefined}
            tabIndex={isMobileLayout ? 0 : undefined}
            aria-labelledby={isMobileLayout ? 'responsive-tab-playback' : undefined}
            hidden={isMobileLayout && activeTab !== 'playback'}
          >
        ...
        <SimulationTransport graphicsStatus={graphicsStatus} />
      </div>
    </div>
  );
}
